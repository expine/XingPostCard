...
public class ClipImageView extends ImageView implements
    ...
    public ClipImageView(Context context, int mWidth, int mHeight) {
        super(context);
        this.mWidth = mWidth;
    ...
    public ClipImageView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.githang.clipimage.R.styleable.ClipImageView);
        mWidth = ta.getInteger(com.githang.clipimage.R.styleable.ClipImageView_civWidth, 1);
        mHeight = ta.getInteger(com.githang.clipimage.R.styleable.ClipImageView_civHeight, 1);
        mClipPadding = ta.getDimensionPixelSize(com.githang.clipimage.R.styleable.ClipImageView_civClipPadding, 0);
        mTipText = ta.getString(com.githang.clipimage.R.styleable.ClipImageView_civTipText);
        mMaskColor = ta.getColor(com.githang.clipimage.R.styleable.ClipImageView_civMaskColor, 0xB2000000);
        final int textSize = ta.getDimensionPixelSize(com.githang.clipimage.R.styleable.ClipImageView_civTipTextSize, 24);
