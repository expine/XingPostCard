...
/**
 * Created by Garfield on 4/30/16.
 */
public class MyImageView extends ImageView implements View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener{
    ...
    public MyImageView(Context context, AttributeSet attrs) {
        ...
        setBorderDistance((int) a.getDimension(R.styleable.MyImageView_ClipSquareIV_BorderDistance, 50));
        setBorderWidth((int) a.getDimension(R.styleable.MyImageView_ClipSquareIV_BorderWidth, 2));
        setBorderColor(a.getColor(R.styleable.MyImageView_ClipSquareIV_BorderColor, Color.WHITE));
        setOutsideColor(a.getColor(R.styleable.MyImageView_ClipSquareIV_OutsideColor, Color.parseColor("#76000000")));
        a.recycle();
    ...
    private void initBmpPosition() {
        ...
        BORDER_LONG = Math.min(outsideRect.width(), outsideRect.height())- 2 * BORDER_DISTANCE ;//- 2 * BORDER_DISTANCE
...
//        int inBottom = outsideRect.height() - inTop;
        int inLeft = BORDER_DISTANCE;
        int inTop=BORDER_DISTANCE;
        int inRight = outsideRect.width();
        int inBottom = outsideRect.height();
    ...
    private class AnimatedZoomRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (((deltaScale > 1f) && (currentScale < targetZoom))
                ...
                // again
                postOnAnimation(MyImageView.this, this);
